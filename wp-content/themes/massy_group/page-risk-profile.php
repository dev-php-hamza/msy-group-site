    ...
    <div class="container">
      ...
      <div class="d-flex flex-wrap align-items-center items_wrapper">
        <div class="item" data-aos="fade-up">
          <img src="<?php echo get_template_directory_uri()?>/assets/images/whatsNext.png" alt="image" />
          <a href="">VIEW 2019 REPORT</a>
        </div>
        <div class="item" data-aos="fade-up" data-aos-delay="50">
          <img src="<?php echo get_template_directory_uri()?>/assets/images/report2018.png" alt="image" />
          <a href="">VIEW 2018 REPORT</a>
        </div>
        <div class="item" data-aos="fade-up" data-aos-delay="100">
          <img src="<?php echo get_template_directory_uri()?>/assets/images/2017Report.png" alt="image" />
          <a href="">VIEW 2017 REPORT</a>
        </div>
        <div class="item" data-aos="fade-up" data-aos-delay="150">
          <img src="<?php echo get_template_directory_uri()?>/assets/images/2016Report.png" alt="image" />
          <a href="">VIEW 2016 REPORT</a>
        </div>
        <div class="item" data-aos="fade-up" data-aos-delay="200">
          <img src="<?php echo get_template_directory_uri()?>/assets/images/2015Report.png" alt="image" />
          <a href="">VIEW 2019 REPORT</a>
        </div>
      </div>
    </div>
